...
const keelson =
  process.env.KEELSON_DIR ?? resolve(import.meta.dir, "../../../../source/keelson/keelson");
...
console.log(`next:  cd ${keelson} && KEELSON_RIBS=beads bun dev`);
