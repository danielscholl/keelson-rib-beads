  ...
  contributeDocs: () => [
    {
      ...
      content: [
        ...
        "gets an honest empty state listing the projects that have one. The board",
        "shows one deterministic view of the scoped project: KPI pulse, the Plan (the",
        "full non-closed backlog as bd's own tree — epics with dotted-id children,",
        "status glyphs ○ ◐ ● ✓ ❄, each row expandable to the bead's description and",
